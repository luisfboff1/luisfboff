...
export async function GET(
  ...
  try {
    ...
    if (!item) {
      return NextResponse.json({ error: 'MovimentoEstoque não encontrado' }, { status: 404 })
    }
...
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json({ error: 'Erro ao atualizar movimentos-estoque' }, { status: 500 })
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({ error: 'Erro ao deletar movimentos-estoque' }, { status: 500 })
  }
}